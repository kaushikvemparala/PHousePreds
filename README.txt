...
for password go to ur user settings on the github website, scroll to the bottom of the menu and click on developer settings and click the personal access tokens drop down
...
Then, j navigate to the PHousePreds folder on terminal and do 
jupyter notebook. 
